    ...
    >
      ...
      <div style={{marginTop:'20px'}} className="flex flex-col gap-4 w-full max-w-md">
        ...
        <button
          ...
          style={{
           padding:'0px 10px' , background: "linear-gradient(135deg, var(--accent-blue), var(--accent-purple))",
            color: "#fff",
          }}
        >
          <img
        ...
        <button
          ...
          className="flex items-center gap-3 p-4 rounded-xl transition-all hover:scale-[1.02]"
          style={{
            padding:'0px 10px' ,  border: "1px solid var(--accent-blue)",
        ...
        <button
          ...
          className="flex items-center gap-3 p-4 rounded-xl transition-all hover:scale-[1.02]"
          style={{
            padding:'0px 10px' ,  border: "1px solid var(--accent-purple)",
            color: "var(--text-primary)",
          }}
        >
          <img
